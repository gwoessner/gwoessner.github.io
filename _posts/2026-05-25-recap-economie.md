...
Pour défendre la faisabilité économique de telles contraintes, Graeber affirme que près de 40 % des emplois actuels sont perçus par leurs employés comme des tâches administratives ou managériales inutiles. En les supprimant et en partageant les gains de productivité de l'IA, 15 heures par semaine suffisent alors largement à faire tourner les secteurs essentiels (santé, alimentation, énergie). <br>
Bregman ajoute que le RUB coûte moins cher à la collectivité que de subir les coûts indirects de la pauvreté (urgences médicales, criminalité). <br>
Il faut aussi noter que le RUB serait d'autant plus facile à financer qu'il a vocation à remplacer tous les flux de redistribution actuels (chomage et RSA, allocations, voire retraites et AAH selon les formes). Ensuite, même si ses défenseurs conviennent qu'un RUB risquerait de provoquer une forte inflation, ils ajoutent que ce serait indolore dans le sens où par construction, l'inflation provoquée serait moins subie par les personnes aux plus faibles revenus, ceux-ci étant ceux qui en proportion verront le plus leurs revenus croitre. On trouvera plus de détails sur le RUB dans [cette vidéo](https://www.youtube.com/watch?v=WUtjf5dXuig).
...
- Comment peut-on être sûrs que suffisamment de personnes iront travailler si le RUB est inconditionnel ? La question de l’impact d’un RUB sur le travail est une question débattue en science économique. Je renvoie à [ce livre](https://laviedesidees.fr/Pour-ou-contre-le-revenu-universel.html) écrit par un économiste spécialiste du RUB et qui y détaille les difficultés qu'il y aurait à le financer. On peut aussi regarder [cet article](https://www.nber.org/papers/w32719) qui analyse une expérience menée au sujet d'un RUB (à savoir que le montant donné ne permettait pas de subvenir à ses besoins), et qui conclut que celui-ci tend à baisser la propension à travailler. Voir également [ce billet de blog](https://www.scottsantens.com/did-sam-altman-basic-income-experiment-succeed-or-fail-ubi/) qui relativise les conclusions de l'expérience précédente. Je renvoie aussi à [mon billet sur la question](www.woessner.ovh/blog/2026/econometrie) pour savoir à quoi ressemblent des études empiriques en économie.
...
[^limites]: Evoquons comme exemple de similarité le fait que les contraintes données sont extérieures au marché et centralisées, donc que rien ne garantit leur compatibilité avec les objectifs. Evoquons aussi le fait que comme la planification, un tel bouleversement économique est radical, aurait des conséquences potentiellement catastrophiques, et que rien ne garantit sa réussite. J'aimerais aussi noter qu'être exhaustif sur cette forme d'anarcho-capitalisme nécessiterait un billet presque aussi long que celui sur la planification, donc je me contente ici d’esquisser le débat.
