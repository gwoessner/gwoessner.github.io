...
Dans la première, qu'on pourrait qualifier d'approche classique, l'idée générale est que plutôt que de chercher un seul critère pour atteindre les objectifs, il faudrait peut-être mieux chercher une famille de critères de scientificité. Il suffirait alors d'en vérifier un seul pour obtenir la qualification de science. C'est d'ailleurs un travail qui s'inscrit dans ce "programme de recherche en épistémologie" qui a été la cause d'un [intense débat sur Twitter](https://twitter.com/CovaFlorian/status/1463132023619522560)[^2] en 2021[^3], où les deux critères sont : la capacité à décrire et prévoir des phénomènes empiriques ; et l'existence d'un cadre théorique cohérent au sein duquel unifier ces observations.  
