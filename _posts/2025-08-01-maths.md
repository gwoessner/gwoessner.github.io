...
<mark>Donc ajoutant l'inverse en déduit que $x^{-1}\cdot x \cdot x = x^{-1}\cdot x$</mark>, les deux côtés de l'équation représentent la même couleur, donc l'équation reste vraie si on ajoute le $x^{-1}$ des deux côtés de l'équation.   
