...
Deuxièmement, celles qui proposent de reprendre la part "volée" par les riches (Approches III et IV) se trompent sur la taille de cette part au regard de celle des travailleurs.
...
Pour conclure, j'aimerais signaler que la rémunération des actionnaires est, en théorie du moins, liée à un service rendu : la bonne allocation du capital, et la prise de risque associée. Je développerai cet aspect (sans pour autant en nier les conséquences négatives) dans un article dédié à la finance. Ce qu'il faut toutefois noter est qu'en cas d'expropriation des capitalistes il faudra que quelqu'un d'autre assure l'allocation du capital et assume les risques associés.
...
[^11]: Il faut souligner que les contribuables ciblés par les approches III (les ultra riches) et IV (les capitalistes) sont en grande partie les mêmes, on ne peut donc pas cumuler ces deux approches !
