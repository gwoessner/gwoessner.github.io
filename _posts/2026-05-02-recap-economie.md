...
- **Coût total employeur :** Aussi appelé superbrut, il comprend les cotisations patronales et les cotisations salariales.
...
- **Flat tax :** Taxe de 30% sur les dividendes reversés aux actionnaires. Elle remplace l'impôt sur le revenu, et est aussi appelée Prélèvement Forfaitaire Unique (PFU).
...
- **Institution sans but lucratif :** Association, club de foot, resto du coeur. N'a pas le droit de faire de bénéfice et n'a donc pas d'actionnaire. Utilise la même convention de comptabilité que les administrations publiques.
