...
<div class="caption">
    A gauche la Figure 1, qu'on peut aussi retrouver [ici](https://fr.wikipedia.org/wiki/Histoire_du_climat).<br>
    A droite la Figure 2.
</div>

Enfin, certains pourraient à juste titre rétorquer que la Figure 2 représente l’évolution de la concentration de gaz à effet de serre (d’ici abrégé GES) plutôt que la température. Mais le Raptor lui même ne nie pas l’effet réchauffant des GES, expliqué dans [cette vidéo](https://www.youtube.com/watch?v=ewc8FBtEKPs), et concernant la température, une animation vaut 1000 mots :

<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include video.liquid path="assets/video/climat-video.mp4" class="img-fluid rounded z-depth-1" controls=true autoplay=true %}
    </div>
</div>
<div class="caption">
    Une animation de l'évolution de la température moyenne sur Terre de 1880 à nos jours, tirée de https://svs.gsfc.nasa.gov/4975.
</div>
